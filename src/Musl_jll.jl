...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Musl_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3490aa6f-05e0-5d3a-9648-5b0c647c155f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Musl", artifacts_toml) for e in artifacts["Musl"]]
...
if best_platform === nothing
    @debug("Unable to load Musl; unsupported platform $(triplet(platform_key_abi()))")
else
